      ...
      <div className="px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="hidden lg:flex items-center gap-2 bg-purple/10 px-4 py-2 border border-purple/30 rounded-full">
              <Search className="w-5 h-5 text-purple" />
              <span className="font-mono font-bold text-purple text-base">FINANCIAL TRACKER</span>
            </div>
          </div>
